...
//@Component
//@Order(3)
public class CompanyClr3 implements CommandLineRunner {
	...
	@Autowired
	public CompanyClr3(LoginController loginController, LoginService loginService,
...
//		------------------------------------------------------------------------------------------------------------
		...
		LoginForm goodLoginForm = new LoginForm("Issta@company.com", "Issta", ClientType.COMPANY);
...
//		------------------------------------------------------------------------------------------------------------
		...
		coup1.setCategory(CouponCategory.VACATION);
		coup1.setTitle("Paris");
		coup1.setDescription("The best vacation EVER.");
		...
		File file1 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Paris.jpg");
		...
		coup2.setCategory(CouponCategory.VACATION);
		coup2.setTitle("Prague");
		...
		File file2 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Prague.jpg");
		...
		coup3.setCategory(CouponCategory.VACATION);
		coup3.setTitle("Paphos");
		coup3.setDescription("The best vacation EVER.");
		...
		File file3 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Paphos.jpg");
		...
		coup4.setCategory(CouponCategory.VACATION);
		coup4.setTitle("Bucharest");
		coup4.setDescription("The best vacation EVER.");
		...
		File file4 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Bucharest.jpg");
		...
		File file5 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Dubai.jpg");
		...
		File file6 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\UnitedArabEmirates.jpg");
		...
		File file7 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\NewYork.jpg");
		...
		File file8 = new File(
				"C:\\Users\\hllyl\\git\\CouponSystem_SpringProject_JwtTechnique\\CouponSystem_SpringProject_JwtTechnique\\src\\main\\resources\\static\\pics\\Companies\\Issta\\Miami.jpg");
