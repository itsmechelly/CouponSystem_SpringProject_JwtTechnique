...
//	------------------------------------------------------------------------------------------------------------
	...
	public ResponseEntity<?> addCompanyCoupon(@ModelAttribute Coupon coupon, @RequestParam MultipartFile imageFile,
	...
	public ResponseEntity<?> updateCompanyCoupon(@ModelAttribute Coupon coupon,
